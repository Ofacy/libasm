...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   libft_convert_lower_hexa.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ibertran <ibertran@student.42lyon.fr>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/23 13:55:54 by ibertran          #+#    #+#             */
/*   Updated: 2024/01/08 19:55:48 by ibertran         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
ssize_t	pf_print_lower_hexa(t_format *format, int nbr)
{
	...
	wr = -1;
	hexa = libft_uitoa_base(nbr, LOWER_HEXA);
	if (hexa)
	{
		i = libft_strlcat(print, hexa, format->totallen + 1);
...
void	pf_lower_hexa_maths(t_format *format, int nbr)
{
	...
	max = 0;
	format->arglen = libft_uitoalen_base(nbr, LOWER_HEXA);
...
{
	if (format->zero)
		libft_memset(print, '0', format->padlen);
	else
